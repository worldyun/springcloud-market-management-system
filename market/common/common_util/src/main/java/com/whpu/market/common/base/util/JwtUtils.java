package com.whpu.market.common.base.util;
...
public class JwtUtils {
    ...
    public static final String APP_SECRET = "ukc8BHGSGFgahfhoihaisoifyaoiuiajkKLHLHISFOhoiahogfoDbRigUDaY6pZFfWus2jZWLPHO";
    ...
    public static String getJwtToken(JwtInfo jwtInfo, int expire){
        ...
        String JwtToken = Jwts.builder()
                ...
                .claim("userType", jwtInfo.getUserType())//用户头像
    ...
    public static JwtInfo getMemberIdByJwtToken(HttpServletRequest request) {
        ...
        JwtInfo jwtInfo = new JwtInfo(claims.get("id").toString(), claims.get("nickname").toString(), Integer.parseInt(claims.get("userType").toString()));
        return jwtInfo;
    }
}
